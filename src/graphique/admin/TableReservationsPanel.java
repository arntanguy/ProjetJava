...
public class TableReservationsPanel extends AbstractTablePanel {
    ...
    private void buildReservationsTable() {
        /*
         * private Passager passager; private Trajet trajet; private boolean
         * modifiable; private int identifiant; private int placesVoulues;
         * private boolean prendCouchette; private Map<String, Boolean>
         * prendRepas;
         */
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            for (final int i : selected) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        // TODO
                        // TrajetSelectorDialog d = new
                        // TrajetSelectorDialog(serveur, parent, i);
                        // d.setVisible(true);
                    }
                });
